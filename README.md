...
> Name is a combination of "flat" + "en**cap**sulation** (from the encapsulation concept from OOP where classes can define `protected`/`internal` and `private` variables)
