...
- The convention for files that are solely meant for build-time (e.g. the "file equivalent" of `devDependencies`) is to use a double underscore prefix (e.g. `__build.ts`).
